...
"[project]/src/app/api/landing-route/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("store_settings").select("homepage_route").eq("id", "default").maybeSingle();
    const route = data?.homepage_route ?? "home";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2cd6eb4d._.js.map