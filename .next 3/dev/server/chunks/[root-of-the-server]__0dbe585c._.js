...
;
async function POST() {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createClient"])();
    await supabase.auth.signOut();
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/admin/login', ("TURBOPACK compile-time value", "http://localhost:3000") || 'https://misstokyo.shop'), {
        status: 302
    });
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0dbe585c._.js.map