...
async function GET() {
    try {
        ...
        const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("profiles").select("role").eq("id", user.id).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f43faaee._.js.map