...
- Name: admin-auth.spec.ts >> Admin login and logout cycle >> valid credentials land on /overview
- Location: tests/e2e/admin-auth.spec.ts:138:9
...
Call log:
  - Expect "toHaveURL" with timeout 20000ms
    5 × unexpected value "http://localhost:3000/admin/login"
    - waiting for" http://localhost:3000/admin/plans" navigation to finish...
    - navigated to "http://localhost:3000/admin/plans"
