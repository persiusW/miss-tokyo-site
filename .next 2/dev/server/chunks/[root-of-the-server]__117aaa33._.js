...
async function proxy(request) {
    ...
    if ((pathname === "/login" || pathname === "/admin/login") && user) {
        ...
        homeUrl.pathname = "/";
        return applySecurityHeaders(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(homeUrl));
    }
